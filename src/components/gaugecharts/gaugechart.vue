            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" style="text-align:left">
                      ...
                      <b-link v-if="this.routeparams && $i18n.locale=='ar'" :href=this.routelink variant="warning" size="md" class="btn float-right"

                              style="background-color:#ffc107;margin-top: 0%; margin-right: 1%; margin-left: 1%;">
                        ...
                        <table align="right" style="margin-top: 0.2rem">
                            <tr>
                              ...
                              <b-link v-if="this.routeparams && $i18n.locale=='en'" :href=this.routelink variant="warning" size="md" class="btn float-right"

                                      style="background-color:#ffc107;margin-top: 0.5%; margin-right: 1%; margin-left: 1%;">
                                <b><i class="fa fa-arrow-left"></i>{{
                                  get_text('back@department_performance@l') }}</b></b-link>
                            </td>
                    ...
                    <div class="card-body">
                        <b-container class="bv-example-row">
                            ...
                            <b-row>
                                ...
                                <b-col cols="2"  v-if="this.$store.state.kpi_value.length > 0">
                                    {{ (this.$store.state.kpi_value[0]['value_type'] == 2 &&
                                  this.$store.state.kpi_value[0]['last_value'] != '' ?
                                  (this.$store.state.kpi_value[0]['last_value']*100).toFixed($store.getters.kpi_rounding) : ((this.$store.state.kpi_value[0]['last_value']) ? (this.$store.state.kpi_value[0]['last_value']).toFixed($store.getters.kpi_rounding).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '')) }} <span
                                                    ...
                                                    <div class="progress-group" style="">
                                                        <div class="progress-group-header" style="margin-bottom:0px">
                                                            <span class="title font-weight-bold"
                                                                  :style="$i18n.locale=='en' ?
                                                                  'border-left: 4px solid #999999' :
                                                                  'border-right: 4px solid #999999' ">&nbsp;{{this.get_text('value_targetted@gaugechart@l') }}{{ ($store.state.kpi_value[0]['value_type'] == 2 && this.target1())? (this.target1()*100).toFixed($store.getters.kpi_rounding).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")+'%' : ((this.target1()) ? this.target1().toFixed($store.getters.kpi_rounding).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : '' ) }}</span>
                                                        </div>
                                                        <!--<div class="progress-group-bars">
                                                            <div class="progress-xs progress"
                                            ...
                                            <div class="brand-card-body" style="padding:1.75rem 0">
                                                <div>
                                                    <div class="text-value">
                                                      ...
                                                      <i v-if="$store.state.performancedebug==1"  style="color:red" class="fas fa-exclamation-triangle fa-1x"></i>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="text-value" dir="ltr">
                                                      ...
                                                      {{
                                                      (kpi_status) ?
                                                      (kpi_status*100).toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") : 0 }}%     <i v-if="this.debug_show_icon_prog==1"  style="color:red" class="fas fa-exclamation-triangle fa-1x"></i>                                               </div>
    ...
    export default {
        ...
        beforeMount() {
          ...
          if (this.routeparams) {
            ...
            this.routelink = "../departmentperformance?query=" + this.sortBySubTenant + ',' + this.sortByMtp + ',' + this.sortByasofperiod + ',' + this.sortByyearno + ',' + 1 + ',' + "sectionreport";
            //departmentperformance?query=9,4,Y,1,1,sectionreport
            if(routeparamsarr[4]) {
              var linktype = routeparamsarr[4];
              if(linktype=='fromsector')
              {
                this.routelink= "../sectionperformance?query=" + this.sortBySubTenant + ',' + this.sortByMtp + ',' + this.sortByasofperiod + ',' + this.sortByyearno+','+0+',sector='+routeparamsarr[5];
              }
            }
            if(routeparamsarr[6]) {
              //alert(routeparamsarr[5]);
              //alert(routeparamsarr[6]);
              this.routelink = "../sectionperformance?query=" + routeparamsarr[0] + ',' + this.sortByMtp + ',' + this.sortByasofperiod + ',' + this.sortByyearno + ',' + routeparamsarr[6] + ',' + 'supervision=' + routeparamsarr[6] + ',' + routeparamsarr[5];

              if(routeparamsarr[7]) {
                this.routelink = "../sectionperformance?query=" + routeparamsarr[0] + ',' + this.sortByMtp + ',' + this.sortByasofperiod + ',' + this.sortByyearno + ',' + routeparamsarr[6] + ',' + 'supervision=' + routeparamsarr[7] + ',' + routeparamsarr[5];
              }
              if(routeparamsarr[6]==2){

             // $ggg=  " sectionperformance?query=48,4,Y,1,39,sector%3D9,fromministry";
                this.routelink= "../sectionperformance?query=" + this.sortBySubTenant + ',' + this.sortByMtp + ',' + this.sortByasofperiod + ',' + this.sortByyearno+','+0+',sector='+routeparamsarr[5]+",fromministry";
      ...
      mounted() {
        ...
        computed: {
            ...
            kpi_status() {
                ...
                //alert(kpi_status)
                if(kpi_status<0){
                  if(this.$store.state.progressdebug==0) {
                    this.debug_show_icon_prog=1;
                    kpi_status = 0;
                  }
                  else{
                    this.debug_show_icon_prog=0;
                  }
                }
