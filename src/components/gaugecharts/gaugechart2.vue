                    ...
                    <div class="card-body">
                        <b-container class="bv-example-row">
                            ...
                            <b-row>
                                ...
                                <b-col cols="2">
                                    {{ this.$store.state.kpi_value[0]['target_value'] !=null?
                                ...
                                <b-col class="donut">
                                        ...
                                        <div class="chart-wrapper">
                                            ...
                                            <div v-if="this.min_allowed1()">
                                                <doughnut-example1 :chartdata=this.min_allowed1()
                                                                   ...
                                                                   :languages="this.get_text('min_allowed@gaugechart@l')"
                                    ...
                                    <b-row>
                                        <div class="chart-wrapper">
                                            ...
                                            <doughnut-example2 :chartdata=this.target1() :improved=this.improved1() :languages="this.get_text('value_targetted@gaugechart@l')"
                                    ...
                                    <b-row>
                                        <div class="chart-wrapper">
                                            ...
                                            <doughnut-example3 :chartdata=this.improved1() :languages="this.get_text('improved@gaugechart@l')" chartId="chart-doughnut-03"
                                                               height="150px"/>
                                        </div>
                                    </b-row>
                                    <br>
...
//   },
        ...
        computed: {
            ...
            kpi_status() {
                ...
                var kpi_status = ((kpi_value[0]['acc_value']!=null)&&(kpi_value[0]['target_value']!=null)) ?(kpi_value[0]['acc_value'] - this.min_allowed1()) / (kpi_value[0]['target_value'] - this.min_allowed1()) : '';
                if (kpi_status != '') {
            ...
            target_diff() {
                ...
                return (kpi_name[0].target_value!=null) ? (kpi_name[0].target_value - kpi_name[0].last_value).toFixed(2) : '';
            },
            quarter_map_values() {
        ...
        methods: {
            ...
            getUpToDateStatus: function () {
                ...
                // alert(this.$store.state.kpi_value[0]['last_value_date'])
                if((this.$store.state.kpi_value[0]['last_value_date'])==undefined)
                {
                                        return '<font color="red">'+this.get_text('out_of_date_reading@gaugechart@l')+'</font><i class="fa fa-exclamation-circle" style="color:#cc043e"></i>'
                ...
                {
                     return '<font color="green">'+this.get_text('updated_reading@gaugechart@l')+'</font><i class="fa fa-check-circle" style="color:#01996d"></i>' 
                }
            ...
            min_allowed1() {
                var kpi_name = this.$store.state.kpi_value;
                var kpi_min_allowed = (kpi_name[0]['target_value']!=null) ? ((kpi_name[0]['target_value']) * (1 - kpi_name[0]['margin_pct'])) : 0;
                var kpi_value_type = (kpi_name.length > 0) ? kpi_name[0]['value_type'] : '';
                // var kpi_improved = (kpi_name.length > 0) ? ((kpi_name[0]['acc_value']) * (1 + kpi_name[0]['margin_pct'])) : ''
            ...
            improved1() {
                var kpi_name = this.$store.state.kpi_value
                var kpi_improved = (kpi_name[0]['target_value']!=null) ? (kpi_name[0]['target_value'] * (1 + kpi_name[0]['margin_pct'])) : 0;
