    ...
    <div class="app">
        <AppHeader fixed>
            ...
            <b-navbar-nav class="d-md-down-none">
                <b-nav-item class="px-3" to="/landingpage">{{ get_text('applications_board@l') }}</b-nav-item>
                <!--<b-nav-item class="px-3" to="/dashboard">{{ this.get_text('Dashboard@l') }}</b-nav-item>
                <b-nav-item class="px-3" to="/users" exact>{{ get_text('users@l') }}</b-nav-item>-->
        ...
        <div class="app-body">
            ...
            <main class="main" style="margin-left: 0;margin-right: 0">
...
<script>
    ...
    import { Header as AppHeader, SidebarToggler, SidebarFooter, SidebarForm, SidebarHeader, SidebarMinimizer, Aside as AppAside, AsideToggler, Footer as TheFooter } from '@coreui/vue'
